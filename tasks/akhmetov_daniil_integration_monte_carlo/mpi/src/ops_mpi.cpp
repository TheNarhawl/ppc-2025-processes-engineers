...
AkhmetovDaniilIntegrationMonteCarloMPI::AkhmetovDaniilIntegrationMonteCarloMPI(const InType &in) {
...
bool AkhmetovDaniilIntegrationMonteCarloMPI::PostProcessingImpl() {
  return true;
}
